...
// 7x5 glyphs for "FSR4" (col 0 = bit 0x40 ... col 6 = bit 0x01).
static const uint8_t g_glyphs[4][5] = {
    {0x7F, 0x40, 0x7F, 0x40, 0x40}, // F
    {0x7F, 0x40, 0x7F, 0x01, 0x7F}, // S
    {0x7F, 0x41, 0x7F, 0x48, 0x44}, // R
    {0x41, 0x41, 0x7F, 0x01, 0x01}, // 4
};
static const int g_gx[4] = {4, 12, 20, 28}; // tight, left-aligned
